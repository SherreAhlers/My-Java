public class PlayingCat {
    ...
    // if the temperature is between 25 and 35 (inclusive).
    ...
    // 1st parameter should be type boolean
    // and be named summer it represents if it is summer.
    // 2nd parameter represents the temperature and
    // is of type int with the name temperature.


    // MY VERSION _ NOT QUITE RIGHT
